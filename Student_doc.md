...
| 13 | As a user I want to see all my bookings and/or my parking spots in a calendar view, so I can quickly understand my schedule and have a clear overview of my reservations. |
| 14 | As a driver I want a map in the homepage that displays all the available parking spots so that I can precisely choose the parking spot position. |
| 15 | As a driver I want to search for available parking spots so that I can book it. |
| 16 | As a driver I want to receive a notifcation when there is a free parking spot near my current position so I can book it if I need it |
| 17 | As a driver I want to be able to search parking spots through filters so that I can find the best parking for my needs. |
| 18 | As a driver I want to search for a parking spot selecting a distance range so that I can find the parking space in the best possible position. |
| 19 | As a driver I want to book a parking spot for a specific interval of time and pay for it so that I can easily park my car. |
| 20 | As a driver I want to see all parking spots available when I search for them, in order to decide myself which I want to book. |
| 21 | As a driver I want to receive the booking confirmation by email when the resident accepts my request, so that I can check the reservation details. |
| 22 | As a driver I want to receive a notification when a resident rejects my request, so I can know whether I have to book another parking spot. |
| 23 | As a driver I want to choose the payment method so that I can pay the parking spot in several digital ways. |
| 24 | As a driver I want to see the list of all my reservations requests, so that I can see which are still waiting to be accepted by the resident and which have been already accepted or rejected. |
| 25 | As a driver I want to be able to delete a reservation request so that I can free a parking spot if I don’t need it anymore. |
| 26 | As a driver I want to rate and comment the parking service so that I can share my parking experience with other drivers. |
| 27 | As a driver I want to access my reputation score on my dashboard so I can know which parking spaces I can book. |
| 28 | As a driver I want to receive the details of the resident after a booking so that I can contact them if needed. |
| 29 | As a driver I want to see all the reviews I have received from the residents so that I can evaluate my behaviour. |
| 30 | As a driver I want to rate the resident whose parking spot I booked, so that I can share my experience. |
| 31 | As a user I want to receive a notifcation when other users leave me reviews and ratings so I can check immediately how was their experience. |
| 32 | As a resident I want to insert into the system my parking space so that I can share it with other users and gain revenues. |
| 33 | As a resident I want to assign labels to my parking spots so that drivers can easily search for them. |
| 34 | As a resident I want to view a list of all my parking spots and add availability time slots, so I can decide when each spot can be booked by the drivers. |
| 35 | As a resident I want to view all booking requests for my parking spots so that I can choose which drivers to authorize for each specific spot and time slot. |
| 36 | As a resident I want to see driver's details and reviews in a request so that I can choose if accept the request. |
| 37 | As a resident I want to reject a reservation request so that I can have the full control of my parking spaces. |
| 38 | As a resident I want to set a reputation treshold to reserve a parking spot, so that I can give priority to higher reputation users. |
| 39 | As a resident I want to rate a driver that used one of my parking spots, so that I can share the related experience. |
| 40 | As a resident I want to receive notifications when a driver asks for a booking so that I’m informed about it. |
| 41 | As a resident I want to receive a notification if a driver cancels their booking request on my parking spot, so I can be updated in real time about the demand for my parking spots. |
| 42 | As a resident I want to see all the reviews I have received from the drivers so that I can evaluate my behaviour. |
...
- As a driver I want to receive a notifcation when there is a free parking spot near my current position so I can book it if I need it
...
- As a user I want to receive a notifcation when other users leave me reviews and ratings so I can check immediately how was their experience.
...
### USER STORIES:
- As a user I want to see all my bookings and/or my parking spots in a calendar view, so I can quickly understand my schedule and have a clear overview of my reservations.
...
- As a driver I want to rate and comment the parking service so that I can share my parking experience with other drivers.
- As a driver I want to rate the resident whose parking spot I booked, so that I can share my experience.
