...
<body style="background: white;" onload="set_hidden_fields();">
    ...
    <section class="search-section" id="searchSection" aria-label="Search parking">
        <form id="searchForm" class="search-wrapper" role="search" aria-label="Search parking"
            action="search_parking.php" method="POST">
            ...
            <div class="controls">
                ...
                <div class="dropdown" id="filtersDropdown">
                    <button class="dropdown-toggle" id="dropdownToggle" aria-haspopup="true"
                        aria-controls="dropdownPanel" aria-expanded="false" type="button">
                        Filters ⌄
                    </button>
                ...
                <div class="dropdown" id="distanceDropdown">
                    <button class="dropdown-toggle" id="distanceToggle" aria-haspopup="true"
                        aria-controls="distancePanel" aria-expanded="false" type="button">
                        Distance ⌄
                    </button>
